...
<body>
    ...
    <div class="container-fluid text-danger text-center mt-3">
        <img src="img/logo_naju.png" width="100">
        <h1 style="font-family: Black And White Picture">Naju Modas e Acessórios</h1>
    </div>
    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
     ...
     <!-- Container fluid para abrigar o contúdo da página -->
